...
public class ModelExtractorFactory {
    ...
    private static final Map<Model, DTSA2Model> map = new HashMap<>();



    public static void register(Model model, DTSA2Model nistModel) {
    ...
    static {
        ...
        // Fluorescence
        register(new Model("fluorescence", "no fluorescence"), new DTSA2Model(
